        ...
        for (int k = 0; k < timeStep; k++) {
            ...
            for (int i = 0; i < weights.size() - 1; i += 4) {
                ...
                if (!currentOldLayers.isEmpty()) {
                    ...
                    ComputationalNode awOu = this.addAdditionEdge(aw, ou, true);
                    ...
                    awOu = this.addAdditionEdge(aw, ou, true);
                    ...
                    aFunction = this.addEdge(tanhCt, ot, false, true);
                } else {
